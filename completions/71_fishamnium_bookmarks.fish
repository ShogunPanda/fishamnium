...
complete -c b -x -a '(bookmarks_autocomplete)'
complete -c e -x -a '(bookmarks_autocomplete)'
complete -c c -x -a '(bookmarks_autocomplete)'
complete -c o -x -a '(bookmarks_autocomplete)'
complete -c s -x -a '(bookmarks_autocomplete)'
complete -c d -x -a '(bookmarks_autocomplete)'
