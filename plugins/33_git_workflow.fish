...
function g_start --wraps git --description "Starts a new branch out of the base one"
...
function g_refresh --wraps git --description "Rebases the current branch on top of an existing remote branch"
  g_is_repository; or return
...
function g_finish --wraps git --description "Merges a branch back to its base remote branch"
  g_is_repository; or return
...
function g_full_finish --wraps git --description "Merges a branch back to its base remote branch and then deletes the local copy"
  set branch (g_branch_name); or return
...
function g_fast_commit --wraps git --description "Creates a local branch, commit changes and then merges it back to the base branch"
  g_is_repository; or return
...
function g_pull_request --wraps git --description "Sends a Pull Request and deletes the local branch"
  g_is_repository; or return
...
function g_fast_pull_request --wraps git --description "Creates a local branch, commit changes and then sends a Pull Request, deleting the local branch at the end"
  g_is_repository; or return
...
function g_release --wraps git --description "Creates and pushes a new release branch out of the base one"
  g_is_repository; or return
...
function g_import --wraps git --description "Imports latest changes to a local branch on top of an existing remote branch"
  g_is_repository; or return
...
function g_start_release --wraps git --description "Starts a new branch out of a remote release branch"
  g_is_repository; or return
...
function g_refresh_release --wraps git --description "Rebases the current branch on top of an existing remote release branch"
  g_is_repository; or return
...
function g_finish_release --wraps git --description "Merges the current branch back to its base remote release branch"
  g_is_repository; or return
...
function g_full_finish_release --wraps git --description "Merges the current branch back to its base remote release branch and then deletes the local copy"
  set branch (g_branch_name); or return
...
function g_import_release --wraps git --description "Imports latest changes to a local branch on top of an existing remote release branch"
  g_is_repository; or return
...
function g_delete_release --wraps git --description "Deletes a release branch locally and remotely"
  g_is_repository; or return

  # Parse arguments
  argparse -i --name=g_delete_release "N/dry-run" -- $argv
  set remote (__g_ensure_remote $_flag_r)
