function __g_status
	if test -n "$dryRun"
		echo -e "$FISHAMNIUM_COLOR_BOLD$FISHAMNIUM_COLOR_SECONDARY--> Would execute: $FISHAMNIUM_COLOR_PRIMARY$argv$FISHAMNIUM_COLOR_RESET"
	else 
		echo -e "$FISHAMNIUM_COLOR_BOLD$FISHAMNIUM_COLOR_PRIMARY--> $argv$FISHAMNIUM_COLOR_RESET"
	end
end
